...
abstract class AbstractWebApiTest {
    ...
    companion object {
        private val postgresContainer: PostgreSQLContainer<*> = PostgreSQLContainer("postgres:14.7-alpine")
            .withReuse(true)
        ...
        fun registerDynamicProperties(registry: DynamicPropertyRegistry) {
            with(registry) {
                ...
                add("spring.flyway.url", postgresContainer::getJdbcUrl)
                add("spring.flyway.user", postgresContainer::getUsername)
                add("spring.flyway.password", postgresContainer::getPassword)
